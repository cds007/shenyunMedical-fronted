...
> Vue2 版本请看 [tag-V4.2.0](https://github.com/lin-xin/shenyunMedical-fronted/tree/V4.2.0)
...
```
git clone https://github.com/lin-xin/shenyunMedical-fronted.git      // 把模板下载到本地
cd shenyunMedical-fronted    // 进入模板目录
